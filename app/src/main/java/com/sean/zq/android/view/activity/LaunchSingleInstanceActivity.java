    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_launch_mode_0).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LaunchSingleInstanceActivity.this, LaunchStandardActivity.class);
        ...
        findViewById(R.id.btn_launch_mode_1).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LaunchSingleInstanceActivity.this, LaunchSingleTopActivity.class);
                startActivity(intent);
            }
        });
        findViewById(R.id.btn_launch_mode_2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LaunchSingleInstanceActivity.this, LaunchSingleTaskActivity.class);
                startActivity(intent);
            }
        });
        findViewById(R.id.btn_launch_mode_3).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LaunchSingleInstanceActivity.this, LaunchSingleInstanceActivity.class);
                startActivity(intent);
            }
        });
